<header itemscope itemtype="http://schema.org/Organization">
    <div class="header-top header-container-main">
        <div class="container">               
            <div class="logo">
                <a href="<?php echo $url; ?>" title="Home - Real Sinalização">
                  <span itemprop="image">
                    <img src="imagens/logo.png" alt="Real Sinalização" title="Real Sinalização" class="img-responsive">
                </span>
            </a>
        </div>               
        <div class="tel">
            <a href="mailto:contato@realsinalizacao.com.br" title="E-mail"><i class="fas fa-envelope"></i> contato@realsinalizacao.com.br</a>
            ...
            <span class="divisor">|</span>
            <a title="Clique e ligue" href="https://wa.me/5511999557929?text=Ol%c3%a1,%20preciso%20de%20informa%c3%a7%c3%b5es" target="_blank">
    ...
    <div class="container">
        ...
        <div class="redes">
            <div class="col-md-4 box-redes border-l">
                <a href="<?php echo $url; ?>#" title="Facebook">
                    <i class="fab fa-facebook-f"></i>
                </a>
            </div>
            <div class="col-md-4 box-redes border-c">
                <a href="<?php echo $url; ?>https://wa.me/5511999557929?text=Ol%c3%a1,%20preciso%20de%20informa%c3%a7%c3%b5es" target="_blank" title="">
                    <i class="fab fa-whatsapp"></i>
                </a>
            </div>
            <div class="col-md-4 box-redes border-r">
                <a href="<?php echo $url; ?>mailto:contato@realsinalizacao.com.br" title="Email">
...
<div class="box-contato-3">
    <a title="Clique e entre em contato via WhatsApp" href="<?php echo $url; ?>https://wa.me/5511999557929" target="_blank">
        <img src="imagens/icones/whatsapp.jpg" alt="WhatsApp" title="WhatsApp" class="img-responsive"><p itemprop="telephone">(11) 99955-7929</p>
    </a>
</div>
</header>